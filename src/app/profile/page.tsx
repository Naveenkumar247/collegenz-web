...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    const fetchUserProfile = async (token: string) => {
      ...
      try {
        // 🟢 FIXED: Ensure the URL matches the path generated by main.ts (api/v1/auth/profile)
        ...
        console.log("DEBUG: API Profile Data Received:", data);

        if (response.ok) {
          // 🟢 FIXED: Map the data correctly. If your API returns { user: {...} }, use data.user
